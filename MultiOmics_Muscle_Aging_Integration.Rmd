...
* **Modest Coupling in Hits:** Even within the subset of "Multi-omics hits" (genes significant in both layers), the correlation remains weak but positive ($\rho \approx 0.13$).
